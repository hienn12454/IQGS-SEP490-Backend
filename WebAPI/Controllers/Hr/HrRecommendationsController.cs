...
public class HrRecommendationsController : ControllerBase
{
    ...
    /// <summary>Danh sách candidate được đề xuất cho HR hiện tại. Filter: status, questionSetId, minScore. Sort: sortBy=score|date, sortDir=asc|desc. Phân trang page/pageSize. Kèm recommendationReason (tính sẵn). Nếu candidate đã ACCEPTED lời mời, còn có invitationResponseMessage/invitationSharedPhoneNumber.</summary>
